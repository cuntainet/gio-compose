...
func (b boxWidget) New(ctx context.Context) internal.Widget {
	return &boxWidget{
		Element: node.Element{
			Name: b.Name,
		},
...
func (b *boxWidget) Update(ctx context.Context, modifiers ...modifier.Modifier[any]) bool {
...
func (b *boxWidget) Layout(gtx layout.Context) (d layout.Dimensions) {
	return b.container.Layout(gtx, b, WidgetPainterFunc(func(gtx layout.Context) layout.Dimensions {
...
func (bc *boxChild) DrawTo(gtx layout.Context, parent Widget, maxSize image.Point, n int) {
